...
if __name__ == '__main__':
    with torch.no_grad():
        ...
        model = Unet(in_channels=4, base_channels=16, num_classes=2)
        model.cuda()
        output = model(x)
