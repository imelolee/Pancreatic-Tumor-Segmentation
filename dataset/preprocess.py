    ...
    for folder in os.listdir(data_path):
        ...
        for filename in os.listdir(a_path):
            if os.path.splitext(filename)[1] == '.gz':
                seg_a_list.append(os.path.join(a_path, filename))
                
            if os.path.splitext(filename)[1] == '.nii':
                img_a_list.append(os.path.join(a_path, filename))
        
        for filename in os.listdir(d_path):
            if os.path.splitext(filename)[1] == '.gz':
        
                seg_d_list.append(os.path.join(d_path, filename))
                
            if os.path.splitext(filename)[1] == '.nii':
                img_d_list.append(os.path.join(d_path, filename))
                
        for filename in os.listdir(v_path):
            if os.path.splitext(filename)[1] == '.gz':
                seg_v_list.append(os.path.join(v_path, filename))
                
            if os.path.splitext(filename)[1] == '.nii':
                img_v_list.append(os.path.join(v_path, filename))
...
def preprocess():
    ...
    for img_idx in range(len(seg_list)):
        ...
        seg_file_list.append(os.path.join(seg_save_path, seg_save_name))
        ct_file_list.append(os.path.join(ct_save_path, ct_save_name))
